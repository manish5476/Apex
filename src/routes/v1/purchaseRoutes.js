...
router.route("/")
  ...
  .post(
    ...
    checkIdempotency, // ✅ Security: Prevents double purchasing
...
router.route("/:id")
  ...
  .delete(checkPermission(PERMISSIONS.PURCHASE.DELETE), purchaseController.deletePurchase); // Secured in controller
