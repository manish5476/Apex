...
const { checkIdempotency } = require('../../middleware/idempotency'); // ✅ Added
...
router.route("/")
  .post(
    ...
    checkIdempotency, // ✅ Security: Prevents double invoicing
...
router.route("/:id")
  ...
  .delete(checkPermission(PERMISSIONS.INVOICE.DELETE), invoiceController.deleteInvoice); // Secured in controller

// --- 🔄 REVERSE LOGISTICS (Returns) ---
// Uses UPDATE permission because it modifies status, stock, and ledger
