...
// ✅ FIX 1: socket util moved to core/utils
const socketUtil = require("@core/utils/socket");

// ✅ FIX 2: cron moved to core/utils
const cronJobs = require("@core/utils/cron");
...
async function startServer() {
  try {
    ...
    // Make io accessible if legacy code needs it
    app.set("io", io);
    ...
    server.listen(PORT, () => {
      ...
      try {
        ...
        cronJobs(); // ✅ proper import usage
        console.log("✅ Cron jobs initialized");
      } catch (err) {
        console.error("⚠️ Cron initialization failed:", err.message);
      }
    });
  } catch (err) {
