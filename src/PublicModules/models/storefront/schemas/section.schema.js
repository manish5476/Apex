// src/storefront/models/schemas/section.schema.js
const mongoose = require('mongoose');
const { nanoid } = require('nanoid');

const SECTION_TYPES = [
  // Premium Layouts & Advanced Visuals
  'bento_grid', 'sticky_scroll_reveal', 'tabbed_showcase', 
  'editorial_hero', 'stacked_cards', 'text_video_mask', 
  'asymmetric_canvas', 'hover_reveal_list', 'split_screen_slider',
  
  // Standard Hero
  'hero_banner', 'video_hero',
  
  // Commerce
  'product_slider', 'product_grid', 'product_listing', 'featured_product', 'shoppable_image',
  
  // Media & Galleries
  'masonry_gallery', 'before_after_slider', 
  
  // Content & Typography
  'text_content', 'split_image_text', 'feature_grid', 'faq_accordion', 'blog_feed', 'category_grid', 'scrolling_marquee',
...
const sectionSchema = new mongoose.Schema({
  ...
  type: {
    ...
    enum: { values: SECTION_TYPES, message: 'Unknown section type: {VALUE}' }
  },
  
  // The central payload containing all design, typography, and structural configs
  config: { 
    type: mongoose.Schema.Types.Mixed, 
    default: {} 
  },
  
  // Relational references kept at the root for easy Mongoose .populate()
  manualData: {
...
module.exports.sectionSchema = sectionSchema;// // src/storefront/models/schemas/section.schema.js
// const mongoose = require('mongoose');
// const { nanoid } = require('nanoid');
...
// // Export for use in SectionRegistry and validators
// module.exports.SECTION_TYPES = SECTION_TYPES;
...
//   isHiddenOnDesktop:{ type: Boolean, default: false }
// }, {
//   _id: false,      // Use nanoid `id` field for frontend keys
//   timestamps: false
// });
