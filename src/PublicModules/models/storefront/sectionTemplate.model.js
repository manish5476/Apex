...
const templateSchema = new mongoose.Schema({
  ...
  // Grouping for the UI Sidebar
  category: { 
    type: String, 
    enum: ['hero', 'product', 'collection', 'content', 'text', 'media', 'social', 'form', 'footer', 'header'],
    required: true,
    index: true 
  },
  ...
  // Default Configuration to load when dropped
  defaultConfig: { type: mongoose.Schema.Types.Mixed, default: {} },

  isPublic: { type: Boolean, default: false }, // Available to all tenants?
...
// const templateSchema = new mongoose.Schema({
//   name: { type: String, required: true, unique: true }, // e.g. "Hero Banner - Modern"
