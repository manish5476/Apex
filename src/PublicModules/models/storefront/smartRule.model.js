// src/storefront/models/smartRule.model.js
...
const filterSchema = new mongoose.Schema({
  ...
  value2: { type: mongoose.Schema.Types.Mixed } // for 'between'
}, { _id: false });
...
const smartRuleSchema = new mongoose.Schema({
  ...
  // ✅ FIX: salesCount added — must match Product schema field path
  sortBy: {
    type: String,
    enum: ['createdAt','sellingPrice','name','lastSold','views','salesCount'],
    default: 'createdAt'
  },
