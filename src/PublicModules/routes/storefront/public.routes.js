...
router.post('/:organizationSlug/account/forgot-password', storefrontCustomerController.forgotPassword);
router.post('/:organizationSlug/account/reset-password', storefrontCustomerController.resetPassword);
router.post('/:organizationSlug/account/update-password', storefrontCustomerController.updatePassword);
...
router.put('/:organizationSlug/account/addresses/:addressId', storefrontCustomerController.updateAddress);
router.post('/:organizationSlug/account/wishlist/toggle', storefrontCustomerController.toggleWishlist);
router.get('/:organizationSlug/account/orders', storefrontCustomerController.getOrders);
