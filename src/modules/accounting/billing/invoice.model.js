...
//     roundOff:      { type: Number, default: 0 },
//     grandTotal:    { type: Number, required: true, default: 0 },
//     shippingCharges: { type: Number, default: 0, min: 0 }, // 🟢 ADD THIS
//     paymentStatus: {
//       type: String,
//       enum: ["unpaid", "partial", "paid"],
//       default: "unpaid",
...
// });
// // ─────────────────────────────────────────────
// //  Pre-Save Middleware: Updated Financials
// // ─────────────────────────────────────────────
// invoiceSchema.pre("save", function (next) {
//   // 🟢 FIX: Trigger recalculation if shippingCharges is modified too
//   if (
//     this.isModified("items") || 
//     this.isModified("paidAmount") || 
//     this.isModified("shippingCharges") || 
...
//     // 🟢 FIX #16: Include shippingCharges in the Grand Total formula
//     const grand = 
//       subTotal - 
//       totalDiscount + 
//       totalTax + 
...
//     this.totalTax      = parseFloat(totalTax.toFixed(2));
//     this.totalDiscount = parseFloat(totalDiscount.toFixed(2));
//     this.shippingCharges = parseFloat((this.shippingCharges || 0).toFixed(2)); // Ensure 2 decimal places
