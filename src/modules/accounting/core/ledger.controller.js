 ...
 * Ledger Controller
 * ─────────────────────────────────────────────
 * Thin HTTP layer for all accounting/ledger endpoints.
 */
...
/* ======================================================
   1. GET ALL LEDGER ENTRIES (journal view)
====================================================== */
exports.getAllLedgers = catchAsync(async (req, res, next) => {
  const result = await LedgerService.getAllLedgers(req.user.organizationId, req.query);
...
exports.getTrialBalance = catchAsync(async (req, res, next) => {
  const result = await LedgerService.getTrialBalance(req.user.organizationId, req.query);
  res.status(200).json({ status: 'success', ...result });
});
...
exports.getProfitAndLoss = catchAsync(async (req, res, next) => {
  const result = await LedgerService.getProfitAndLoss(req.user.organizationId, req.query);
  res.status(200).json({ status: 'success', ...result });
});
...
exports.getBalanceSheet = catchAsync(async (req, res, next) => {
  const result = await LedgerService.getBalanceSheet(req.user.organizationId, req.query);
  res.status(200).json({ status: 'success', ...result });
});
...
exports.getRetainedEarnings = catchAsync(async (req, res, next) => {
  const retainedEarnings = await LedgerService.getRetainedEarnings(
    req.user.organizationId, req.query
  );
  res.status(200).json({ status: 'success', data: { retainedEarnings } });
});

/* ======================================================
   8. ORG LEDGER SUMMARY
====================================================== */
exports.getOrganizationLedgerSummary = catchAsync(async (req, res, next) => {
  const result = await LedgerService.getOrganizationLedgerSummary(
    req.user.organizationId, req.query
  );
...
exports.getCashFlow = catchAsync(async (req, res, next) => {
  const result = await LedgerService.getCashFlow(req.user.organizationId, req.query);
  res.status(200).json({ status: 'success', ...result });
});
...
exports.getAccountDrillDown = catchAsync(async (req, res, next) => {
  const docs = await LedgerService.getAccountDrillDown(
...
exports.exportLedgers = catchAsync(async (req, res, next) => {
  ...
  for (const e of entries) {
    ...
    sheet.addRow({
      ...
      partyType:   e.customer ? 'Customer' : e.supplier ? 'Supplier' : 'None',
