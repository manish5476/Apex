...
====================================================== */
exports.createSalesReturn = catchAsync(async (req, res, next) => {
  const salesReturn = await SalesReturnService.createSalesReturn(req.body, req.user);
...
====================================================== */
exports.updateSalesReturn = catchAsync(async (req, res, next) => {
...
/* ======================================================
   3. DELETE SALES RETURN
====================================================== */
exports.deleteSalesReturn = catchAsync(async (req, res, next) => {
  await SalesReturnService.deleteSalesReturn(req.params.id, req.user);
...
exports.createReturn = catchAsync(async (req, res, next) => {
  await SalesReturnService.createReturn(req.body, req.user);
...
====================================================== */
exports.getAllSalesReturns = factory.getAll(SalesReturn);
exports.getSalesReturn = factory.getOne(SalesReturn);
