...
// Compound Index: unique branch codes per organization
branchSchema.index({ organizationId: 1, branchCode: 1 }, { unique: true, sparse: true });
// Geo Index: for location proximity searches
