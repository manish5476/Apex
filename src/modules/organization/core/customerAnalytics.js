...
class AnalyticsController {
  ...
  /**
   * Helper: Get Timezone
   * (Keep as normal method or arrow, but arrow is safer)
   */
  getTimezone = (req) => {
  ...
  getCustomerOverview = async (req, res) => {
    try {
      ...
      // Now 'this' refers to the AnalyticsController instance
  ...
  // =================================================================
  // 👇 CHANGED TO ARROW FUNCTION
  getCustomerFinancialAnalytics = async (req, res) => {
    try {
      const { organizationId } = req.user;
      const { customerId, year } = req.query;
      const currentYear = parseInt(year) || new Date().getFullYear();
      const timezone = this.getTimezone(req); // Works now
      ...
      // 👇 This call also required 'this' to be valid
  ...
  // =================================================================
  // 👇 CHANGED TO ARROW FUNCTION
  getCustomerPaymentBehavior = async (req, res) => {
    try {
      const { organizationId } = req.user;
  ...
  // =================================================================
  // 👇 CHANGED TO ARROW FUNCTION
  getCustomerLifetimeValue = async (req, res) => {
    try {
      const { organizationId } = req.user;
  ...
  // =================================================================
  // 👇 CHANGED TO ARROW FUNCTION
  getCustomerSegmentation = async (req, res) => {
    try {
      const { organizationId } = req.user;
  ...
  // =================================================================
  // 👇 CHANGED TO ARROW FUNCTION
  getCustomerEMIAnalytics = async (req, res) => {
    try {
      const { organizationId } = req.user;
  ...
  // =================================================================
  // 👇 CHANGED TO ARROW FUNCTION
  getCustomerGeospatial = async (req, res) => {
    try {
      const { organizationId } = req.user;
  ...
  // =================================================================
  // 👇 CHANGED TO ARROW FUNCTION
  exportFinancialsToCSV = async (req, res) => {
    try {
        const { organizationId } = req.user;
