...
const organizationSchema = new mongoose.Schema({
  ...
  // NOTE: branches[] is kept only as a lightweight cache/reference list.
  // Source of truth for branch membership is Branch.organizationId.
  // Do NOT use this array for financial logic or member counts.
  ...
  // Billing Address (printed on invoices — separate from owner's personal contact)
