...
//         if (!canApprove && !['admin', 'owner'].includes(req.user.role)) {
//             return next(new AppError('You are not authorized to approve this request', 403));
//         }
...
//  */
// exports.getPendingRequests = catchAsync(async (req, res, next) => {
//     const { branchId, startDate, endDate, type, limit = 50, page = 1 } = req.query;
//     const filter = {
//         organizationId: req.user.organizationId,
//         status: { $in: ['pending', 'under_review'] }
//     };
...
//     const filter = {
//         organizationId: req.user.organizationId,
//         date: { $gte: startDate || dayjs().startOf('month').format('YYYY-MM-DD'), 
//                 $lte: endDate || dayjs().format('YYYY-MM-DD') }
//     };
