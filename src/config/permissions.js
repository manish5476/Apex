...
//     // -----------------------------------------------------------
//     { tag: "note:read", group: "Notes & Planner", description: "View notes, tasks, and journal entries", },
//     { tag: "note:write", group: "Notes & Planner", description: "Create and update notes", },
//     { tag: "note:delete", group: "Notes & Planner", description: "Delete notes", },
//     { tag: "note:share", group: "Notes & Planner", description: "Share notes with other users", },
//     { tag: "note:manage_shared", group: "Notes & Planner", description: "Manage access to shared notes", },
//     { tag: "note:create_template", group: "Notes & Planner", description: "Create note templates", },
//     { tag: "note:use_template", group: "Notes & Planner", description: "Use existing templates", },
//     { tag: "note:manage_templates", group: "Notes & Planner", description: "Manage organization templates", },
//     { tag: "note:view_analytics", group: "Notes & Planner", description: "View note analytics and heat maps", },
//     { tag: "note:export_data", group: "Notes & Planner", description: "Export note data", },
//     { tag: "note:bulk_update", group: "Notes & Planner", description: "Update multiple notes at once", },
//     { tag: "note:bulk_delete", group: "Notes & Planner", description: "Delete multiple notes at once", },
//     { tag: "note:view_calendar", group: "Notes & Planner", description: "View calendar with notes and meetings", },
//     { tag: "note:manage_calendar", group: "Notes & Planner", description: "Manage calendar events", },
//     { tag: "note:convert_task", group: "Notes & Planner", description: "Convert notes to tasks", },
//     { tag: "note:pin", group: "Notes & Planner", description: "Pin important notes", },
...
//     // Add these to your PERMISSIONS_LIST array:
...
//     // HOLIDAY MANAGEMENT
//     { tag: "holiday:read", group: "System", description: "View holidays" },
//     { tag: "holiday:manage", group: "System", description: "Create/update/delete holidays" },

//     // SHIFT MANAGEMENT
//     { tag: "shift:read", group: "System", description: "View shifts" },
//     { tag: "shift:manage", group: "System", description: "Create/update/delete shifts" },
...
//     // PAYMENT (missing from invoice routes)
//     { tag: "payment:update", group: "Finance", description: "Update payment records" },
...
//     // FEED
//     { tag: "feed:read", group: "Customer", description: "View customer activity feed" },

//     // MISSING ANALYTICS (based on your chart routes)
//     { tag: "analytics:chart_view", group: "Analytics", description: "View chart visualizations" },
//     { tag: "analytics:export_charts", group: "Analytics", description: "Export chart data" },

//     // DASHBOARD (specific)
//     { tag: "dashboard:view", group: "Analytics", description: "View dashboard overview" },
//     // -----------------------------------------------------------
...
//     { tag: "invoice:delete", group: "Sales", description: "Delete Invoices" },
//     { tag: "invoice:download", group: "Sales", description: "Download / Email Invoice" },
//     { tag: "invoice:export", group: "Sales", description: "Export Invoices (CSV/Excel)" }, // NEW
//     { tag: "invoice:history", group: "Sales", description: "View Invoice Audit History" }, // NEW

//     { tag: "sales:manage", group: "Sales", description: "Manage Direct Sales" },
//     { tag: "sales:view", group: "Sales", description: "View Sales & Exports" },

//     // -----------------------------------------------------------
//     // STOCK MANAGEMENT (Related to Invoice Stock Control)
//     // -----------------------------------------------------------
//     { tag: "stock:validate", group: "Inventory", description: "Validate Stock Before Sales" }, // NEW
//     { tag: "stock:warnings", group: "Inventory", description: "View Low Stock Warnings" }, // NEW

//     // -----------------------------------------------------------
//     // REPORTS (Invoice Reports)
//     // -----------------------------------------------------------
//     { tag: "report:profit", group: "Reports", description: "View Profit Reports" }, // NEW
//     { tag: "report:sales", group: "Reports", description: "View Sales Reports" }, // NEW
//     { tag: "report:tax", group: "Reports", description: "View Tax Reports" }, // NEW
//     { tag: "report:outstanding", group: "Reports", description: "View Outstanding Invoices" }, // NEW

//     // -----------------------------------------------------------
//     // DRAFTS (Invoice Draft Management)
//     // -----------------------------------------------------------
//     { tag: "draft:view", group: "Sales", description: "View Draft Invoices" }, // NEW
//     { tag: "draft:delete", group: "Sales", description: "Delete Draft Invoices" }, // NEW
//     { tag: "draft:convert", group: "Sales", description: "Convert Draft to Active" }, // NEW

//     // -----------------------------------------------------------
//     // BULK OPERATIONS
//     // -----------------------------------------------------------
//     { tag: "bulk:invoice:create", group: "Sales", description: "Bulk Create Invoices" }, // NEW
//     { tag: "bulk:invoice:update", group: "Sales", description: "Bulk Update Invoice Status" }, // NEW
//     { tag: "bulk:invoice:cancel", group: "Sales", description: "Bulk Cancel Invoices" }, // NEW
//     { tag: "bulk:invoice:delete", group: "Sales", description: "Bulk Delete Drafts" }, // NEW

//     // -----------------------------------------------------------
//     // RECURRING INVOICES
//     // -----------------------------------------------------------
//     { tag: "recurring:invoice:create", group: "Sales", description: "Create Recurring Invoice Templates" }, // NEW
//     { tag: "recurring:invoice:generate", group: "Sales", description: "Generate Recurring Invoices" }, // NEW

//     // -----------------------------------------------------------
//     // INTEGRATIONS
//     // -----------------------------------------------------------
//     { tag: "integration:webhook", group: "Integrations", description: "Trigger Invoice Webhooks" }, // NEW
//     { tag: "integration:accounting", group: "Integrations", description: "Sync with Accounting Software" }, // NEW
...
//     // -----------------------------------------------------------
//     { tag: "attendance:read", group: "Attendance", description: "View attendance records", },
//     { tag: "attendance:mark", group: "Attendance", description: "Mark attendance", },
//     { tag: "attendance:approve", group: "Attendance", description: "Approve attendance", },
//     { tag: "attendance:export", group: "Attendance", description: "Export attendance reports", },
//     { tag: "timesheet:read", group: "Attendance", description: "View timesheets", },
//     { tag: "timesheet:submit", group: "Attendance", description: "Submit timesheets", },
//     { tag: "timesheet:approve", group: "Attendance", description: "Approve timesheets", },
...
//     permissions.forEach((perm) => {
//         if (VALID_TAGS.includes(perm)) { valid.push(perm); } else { invalid.push(perm); }
//     });

//     return {
//         valid, invalid, isValid: invalid.length === 0,
//     };
// };
...
// // Add wildcard support to VALID_TAGS
// const VALID_TAGS_WITH_WILDCARD = [...VALID_TAGS, "*"];

// // Add category wildcards (e.g., "note:*", "analytics:*")
// const VALID_TAGS = [...PERMISSIONS_LIST.map((p) => p.tag), "*"];

// // Add all category wildcards
// PERMISSIONS_LIST.forEach((p) => {
//     const [category] = p.tag.split(":");
//     const categoryWildcard = `${category}:*`;
//     if (!VALID_TAGS.includes(categoryWildcard)) {
