...
const PERMISSIONS_LIST = [
    ...
    { tag: "role:manage", group: "System", description: "Create and edit system roles and permissions mapping" },
    { tag: "session:view_all", group: "System", description: "View all active system sessions across the organization" },
    ...
    { tag: "org:manage", group: "Organization", description: "Manage own organization settings" },
    { tag: "org:manage_members", group: "Organization", description: "Invite or remove organization members" },
    { tag: "org:transfer", group: "Organization", description: "Transfer organization ownership" },
    ...
    { tag: "department:read", group: "Organization", description: "View department lists and hierarchy" },
    { tag: "department:manage", group: "Organization", description: "Manage department structure" },
    { tag: "designation:read", group: "Organization", description: "View job titles and career paths" },
    { tag: "designation:manage", group: "Organization", description: "Manage designations and salary bands" },

    // --- FINANCE & ACCOUNTING ---
    { tag: "account:read", group: "Finance", description: "View the Chart of Accounts" },
    { tag: "account:manage", group: "Finance", description: "Manage account structure and hierarchy" },
    { tag: "ledger:read", group: "Finance", description: "View General Ledger and Financial Statements" },
    { tag: "ledger:delete", group: "Finance", description: "Void/Delete Ledger entries (High Risk)" },
    { tag: "statement:read", group: "Finance", description: "View P&L, Balance Sheet, and Trial Balance" },
    { tag: "transaction:read", group: "Finance", description: "View all financial transactions" },
    { tag: "payment:read", group: "Finance", description: "View payment records and reports" },
    { tag: "payment:create", group: "Finance", description: "Record new payments" },
    { tag: "payment:update", group: "Finance", description: "Update and allocate payments" },
    { tag: "payment:delete", group: "Finance", description: "Delete/Void payments" },
    { tag: "reconciliation:read", group: "Finance", description: "View reconciliation reports" },
    { tag: "reconciliation:manage", group: "Finance", description: "Perform bank/cash reconciliations" },
    { tag: "emi:read", group: "Finance", description: "View EMI plans and schedules" },
    { tag: "emi:create", group: "Finance", description: "Create new installment/loan plans" },
    { tag: "emi:pay", group: "Finance", description: "Process installment payments" },
    { tag: "emi:manage", group: "Finance", description: "Modify or delete EMI plans" },

    // --- SALES & BILLING ---
    { tag: "sales:view", group: "Sales", description: "View sales dashboards and exports" },
    { tag: "sales:manage", group: "Sales", description: "Process direct sales and POS" },
    { tag: "sales_return:read", group: "Sales", description: "View sales return records" },
    { tag: "sales_return:manage", group: "Sales", description: "Process/Authorize sales returns" },
    { tag: "invoice:read", group: "Billing", description: "View invoices and billing analytics" },
    { tag: "invoice:create", group: "Billing", description: "Generate new invoices" },
    { tag: "invoice:update", group: "Billing", description: "Edit or cancel existing invoices" },
    { tag: "invoice:delete", group: "Billing", description: "Permanently delete invoices" },
    { tag: "invoice:download", group: "Billing", description: "Download or Email invoice PDFs" },
    { tag: "invoice:export", group: "Billing", description: "Export billing data to CSV/Excel" },

    // --- INVENTORY & STOCK ---
    { tag: "product:read", group: "Inventory", description: "View products and pricing" },
    { tag: "product:create", group: "Inventory", description: "Add new products to catalog" },
    { tag: "product:update", group: "Inventory", description: "Edit product details and pricing" },
    { tag: "product:delete", group: "Inventory", description: "Remove products from catalog" },
    { tag: "product:stock_adjust", group: "Inventory", description: "Manual stock corrections" },
    { tag: "stock:read", group: "Inventory", description: "View stock levels and movements" },
    { tag: "stock:manage", group: "Inventory", description: "Manage inter-branch transfers" },
    { tag: "stock:low_stock", group: "Inventory", description: "Access low stock alerts and reports" },
    { tag: "supplier:read", group: "Inventory", description: "View supplier profiles" },
    { tag: "supplier:create", group: "Inventory", description: "Add new suppliers" },
    { tag: "supplier:update", group: "Inventory", description: "Edit supplier details and KYC" },

    // --- PURCHASE ---
    { tag: "purchase:read", group: "Purchase", description: "View purchase orders and bills" },
    { tag: "purchase:create", group: "Purchase", description: "Create new purchase records" },
    { tag: "purchase:update", group: "Purchase", description: "Edit purchase records" },
    { tag: "purchase:payment:view", group: "Purchase", description: "View vendor payment history" },
    { tag: "purchase:payment:create", group: "Purchase", description: "Record vendor payments" },

    // --- HR & ATTENDANCE ---
    { tag: "attendance:read", group: "HR", description: "View personal and team attendance" },
    { tag: "attendance:manage", group: "HR", description: "Process and recalculate attendance" },
    { tag: "attendance:log_read", group: "HR", description: "View raw biometric and realtime logs" },
    { tag: "attendance:log_manage", group: "HR", description: "Correct or flag raw attendance logs" },
    { tag: "attendance:machine_read", group: "HR", description: "View biometric hardware status" },
    { tag: "attendance:machine_manage", group: "HR", description: "Manage hardware and API keys" },
    { tag: "attendance:geofence_read", group: "HR", description: "View location-based tracking zones" },
    { tag: "attendance:geofence_manage", group: "HR", description: "Manage GPS/Geofence boundaries" },
    { tag: "holiday:read", group: "HR", description: "View company holiday calendar" },
    { tag: "holiday:manage", group: "HR", description: "Manage holiday list and year-copy" },
    { tag: "shift:read", group: "HR", description: "View shift definitions and timelines" },
    { tag: "shift:manage", group: "HR", description: "Manage shift templates and rotations" },
    { tag: "leave:read", group: "HR", description: "View leave history and balances" },
    { tag: "leave:request", group: "HR", description: "Apply for personal leave" },
    { tag: "leave:approve", group: "HR", description: "Approve/Reject leave requests" },
    { tag: "leave:balance_manage", group: "HR", description: "Initialize and accrue leave balances" },

    // --- COMMUNICATION & AI ---
    { tag: "chat:read", group: "Communication", description: "Read chat messages and channels" },
    { tag: "chat:send", group: "Communication", description: "Participate in chats and send files" },
    { tag: "chat:manage_channel", group: "Communication", description: "Create and manage chat channels" },
    { tag: "announcement:read", group: "Communication", description: "View company announcements" },
    { tag: "announcement:manage", group: "Communication", description: "Post and manage announcements" },
    { tag: "notification:read", group: "Communication", description: "View personal notifications" },
    { tag: "ai:chat", group: "System", description: "Interact with the AI Assistant for data queries" },

    // --- ANALYTICS & DASHBOARD ---
    { tag: "dashboard:view", group: "General", description: "Access main dashboard KPIs" },
    { tag: "analytics:read", group: "Analytics", description: "View standard charts and trends" },
    { tag: "analytics:view_executive", group: "Analytics", description: "Access high-level company performance dashboards" },
    { tag: "analytics:view_financial", group: "Analytics", description: "Access sensitive financial intelligence" },
    { tag: "analytics:export_data", group: "Analytics", description: "Export raw analytical data to CSV" },

    // --- AUTOMATION & INTEGRATION ---
    { tag: "automation:read", group: "System", description: "View configured automations" },
    { tag: "automation:webhook", group: "System", description: "Manage external webhooks" },
    { tag: "automation:workflow", group: "System", description: "Manage internal logic workflows" },
];
