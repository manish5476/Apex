...
// /**
//  * Generate an invoice PDF buffer by invoiceId
//  * @returns {Buffer}
//  */
// exports.generateInvoicePDF = async (invoiceId, organizationId) => {
//   const invoice = await Invoice.findOne({
...
//   if (!customer?.email)
//     throw new AppError(
//       "Customer email not available for sending invoice.",
//       400,
//     );
...
//   console.log(
//     `📧 Invoice ${invoice.invoiceNumber} emailed to ${customer.email}`,
//   );
//   return true;
// };
...
// exports.sendInvoiceToCustomer = async (invoiceId, orgId) => {
//   const invoice = await Invoice.findOne({
//     _id: invoiceId,
...
//     .populate(
//       "organizationId",
//       "name primaryEmail themePrimary themeAccent website",
//     );
...
//   if (!customer?.email) throw new AppError("Customer email not available", 400);
