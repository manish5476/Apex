...
// supplierSchema.index({ organizationId: 1, email: 1 }, { unique: true, sparse: true });
// supplierSchema.index({ organizationId: 1, phone: 1 }, { unique: true, sparse: true });
// supplierSchema.index({ organizationId: 1, gstNumber: 1 }, { unique: true, sparse: true });


// // --- Virtual for Display Name ---
// supplierSchema.virtual('displayName').get(function () { return this.contactPerson ? `${this.companyName} (${this.contactPerson})` : this.companyName; });
