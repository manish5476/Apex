...
//   // approvalRequests array contains objects like:
//   // { _id: userId, requestedAt: Date }
//   const requests = org.approvalRequests;

//   // Extract all user IDs
//   const userIds = requests.map(r => r._id);
...
//   // Merge requestedAt into user object
//   const pendingMembers = users.map(user => {
//     const req = requests.find(r => String(r._id) === String(user._id));

//     return {
//       ...user,
//       requestedAt: req?.requestedAt || user.createdAt
//     };
//   });
